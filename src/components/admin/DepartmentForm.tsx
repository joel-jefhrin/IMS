...
export function DepartmentForm({ department, onClose, onSubmit }: DepartmentFormProps) {
  ...
  const totalWeight = Number(formData.technicalWeight) + Number(formData.behavioralWeight) + Number(formData.logicalWeight);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="pt-6 border-t">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <p className="text-sm text-gray-700 mb-3">
                Set the weightage for different skill types. Total must equal 100%.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`input ${!isWeightValid ? 'border-danger-500' : ''}`}
                    min="0"
                    max="100"
                    required
                  />
              ...
              <div className="mt-3 flex items-center justify-between">
                ...
                <span className={`text-lg font-bold ${isWeightValid ? 'text-success-600' : 'text-danger-600'}`}>
                  {totalWeight}%
                </span>
              </div>
          ...
          <div className="pt-6 border-t">
            ...
            <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
              <p className="text-sm font-medium text-gray-900 mb-3">Evaluation Breakdown:</p>
              <div className="space-y-2">
                <div className="flex items-center">
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-gray-700">Technical</span>
                      <span className="text-sm font-semibold text-gray-900">{formData.technicalWeight}%</span>
                    </div>
                ...
                <div className="flex items-center">
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-semibold text-gray-900">{formData.behavioralWeight}%</span>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div
                ...
                <div className="flex items-center">
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-semibold text-gray-900">{formData.logicalWeight}%</span>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div
