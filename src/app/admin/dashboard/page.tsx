        ...
        <div className="card p-6 border-l-4 border-primary-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">{kpis.departments}</p>
        ...
        <div className="card p-6 border-l-4 border-success-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">{kpis.questions}</p>
        ...
        <div className="card p-6 border-l-4 border-warning-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">{kpis.activeCampaigns}</p>
              <p className="text-xs text-warning-600 mt-1">{kpis.campaigns} total</p>
            </div>
        ...
        <div className="card p-6 border-l-4 border-primary-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">{kpis.candidates}</p>
              <p className="text-xs text-gray-600 mt-1">{kpis.completedInterviews} completed</p>
            </div>
        ...
        <div className="card p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-success-600">↑ Excellent performance</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{kpis.inProgressInterviews}</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {((kpis.completedInterviews / kpis.candidates) * 100).toFixed(0)}%
              </p>
              <p className="text-xs text-gray-600">{kpis.completedInterviews}/{kpis.candidates} completed</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-semibold text-gray-900">{kpis.departments}</span>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-semibold text-gray-900">{kpis.questions}</span>
              </div>
              <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-success-600 rounded-full" style={{ width: '80%' }} />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-semibold text-gray-900">{kpis.campaigns} ({kpis.activeCampaigns} active)</span>
              </div>
              <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-warning-600 rounded-full" style={{ width: '50%' }} />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-semibold text-gray-900">{kpis.candidates}</span>
              </div>
              <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-primary-600 rounded-full" style={{ width: '30%' }} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-success-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600">Sarah Johnson scored 95% in Frontend Dev Hiring</p>
            ...
            <div className="flex items-start gap-3 p-3 bg-warning-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600">Michael Chen is taking the Data Science test</p>
            ...
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Candidate Added</p>
                <p className="text-xs text-gray-600">Emily Davis invited to Product Design campaign</p>
            ...
            <div className="flex items-start gap-3 p-3 bg-primary-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600">All 4 modules configured and operational</p>
